...
#undef  STATUSLED_EMS_TX_SUPPORT
#undef  STATUSLED_RX_SUPPORT
#undef  STATUSLED_RFM12_RX_SUPPORT
#undef  STATUSLED_ZBUS_RX_SUPPORT
#undef  STATUSLED_IRMP_RX_SUPPORT
#undef  STATUSLED_EMS_RX_OK_SUPPORT
#undef  STATUSLED_ERROR_SUPPORT
#undef  STATUSLED_EMS_RX_FAIL_SUPPORT
 ...
 * Network
 */
#define CONF_HOSTNAME "Coffeetable"
#define NET_MAX_FRAME_LENGTH (500)
#define ENC28J60_SUPPORT 1
#define CONF_ENC_MAC  "\x02\xca\xfe\xa7\x6e\x34"
#undef  IPV6_STATIC_SUPPORT
#define set_CONF_ENC_IP(ip) uip_ipaddr((ip), 192,168,2,151 )
#define CONF_ENC_IP "192.168.2.151"
...
#define set_CONF_ETHERSEX_GATEWAY(ip) uip_ipaddr((ip), 192,168,2,1 )
#define CONF_ETHERSEX_GATEWAY "192.168.2.1"
 ...
 */
#define CONFIG_AVRDUDE_PROGRAMMER usbasp
#define AVRDUDE_PROGRAMMER usbasp
#define CONFIG_AVRDUDE_PORT "/dev/tty.usbserial"
#define AVRDUDE_PORT /dev/tty.usbserial
#undef  CONFIG_AVRDUDE_VERBOSE
#define AVRDUDE_VERBOSE -v
#undef  CONFIG_AVRDUDE_NO_VERIFY
#undef  CONFIG_AVRDUDE_ERASE_COUNTER
#define CONFIG_AVRDUDE_BITCLOCK AVRDUDE_BITCLOCK_1
#define AVRDUDE_BITCLOCK "-B 4"
#define CONFIG_AVRDUDE_EXTRA_OPTIONS ""
#define CONFIG_AVRDUDE_LFUSE ""
#define AVRDUDE_LFUSE INVALID_VALUE
#define CONFIG_AVRDUDE_HFUSE ""
#define AVRDUDE_HFUSE INVALID_VALUE
#define CONFIG_AVRDUDE_EFUSE ""
#define AVRDUDE_EFUSE INVALID_VALUE
